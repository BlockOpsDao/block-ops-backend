...
contract TestOpsNFT is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function tokenDetails(uint256 _tokenId) public view returns (address, string memory, uint256) {
        ...
        return (nftOwner, tokenMetadata, amount);
    }
    ...
    function redeemEthFromNFT(uint256 _tokenId) external {
        (address nftOwner, string memory tokenMetadata, uint256 amount) = tokenDetails(_tokenId);
